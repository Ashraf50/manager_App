  ...
  Widget build(BuildContext context) {
    return BlocListener<TicketCubit, TicketState>(
      ...
      child: CustomScaffold(
        appBar: CustomAppBar(title: S.of(context).assign_ticket),
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              MaxTimeInputField(controller: timeController),
              const SizedBox(
                height: 10,
              ),
              CustomButton(
                ...
                onTap: () async {
                  if (selectedTicketianId == null) {
                    CustomToast.show(
                      message: S.of(context).please_select_ticketian,
                      backgroundColor: Colors.red,
                      alignment: Alignment.topCenter,
                    );
                    return;
                  ...
                  await cubit.assignTicketian(
                    ...
                    maximumMinutes: timeController.text.trim().isEmpty
                        ? null
