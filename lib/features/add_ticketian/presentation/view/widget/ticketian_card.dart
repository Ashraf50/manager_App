...
class TicketianCard extends StatefulWidget {
  final TicketianModel ticketian;
  const TicketianCard({super.key, required this.ticketian});

  @override
  State<TicketianCard> createState() => _TicketianCardState();
}

class _TicketianCardState extends State<TicketianCard> {
  ...
  void _showEditDialog(BuildContext context) {
    final nameController =
        TextEditingController(text: widget.ticketian.user!.name!);
    final emailController =
        TextEditingController(text: widget.ticketian.user!.email!);
    final phoneController =
        TextEditingController(text: widget.ticketian.user?.phone ?? "N/A");
                ...
                BlocProvider(
                  create: (context) =>
                      SelectableSectionCubit(TicketianRepoImpl(ApiHelper()))
                        ..fetchSelectableSections(
                            serviceId: widget.ticketian.section!.serviceId!),
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              context
                  .read<AddTicketianCubit>()
                  .deleteTicketian(widget.ticketian.id!);
              SmartDialog.dismiss();
            },
            child: Text(S.of(context).delete,
