...
import 'package:manager_app/features/settings/data/setting_repo_impl.dart';
import 'package:manager_app/features/settings/presentation/view_model/setting_cubit.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            BlocProvider(
              create: (context) =>
                  SettingsCubit(SettingRepoImpl(ApiHelper()))..fetchSettings(),
                ...
                builder: (context, state) {
                  return Row(
                    ...
                    children: [
                      ...
                      Switch(
                        value: state.automaticAssignment,
                        onChanged: (value) {
                          context.read<SettingsCubit>().toggleAssignment(value);
                        },
