    ...
    return Material(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            _menuItem(Icons.copy, S.of(context).copy, onCopy,
                color: Colors.black),
            _menuItem(Icons.delete, S.of(context).delete, onDelete,
                color: Colors.red),
            _menuItem(Icons.delete_forever, S.of(context).delete_for_all,
                onDeleteForAll,
                color: Colors.red),
          ],
        ),
